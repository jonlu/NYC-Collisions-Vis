...
#### Some Notes
Implementation for this project was done in d3 and Mapbox. The dataset (parsed and reduced) is hosted locally, so the page may be slow to render on the first pass. The visualization is known to be buggy on Safari. 
